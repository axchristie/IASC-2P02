...
************/
// Cube Geometry
const cubeGeometry = new THREE.BoxGeometry(0.5, 0.5, 0.5, 1, 1)
...
//const redMaterial = new THREE.MeshStandardMaterial({ color: new THREE.Color('red'), name: 'voldermort', wireframe: false })
//const greenMaterial = new THREE.MeshStandardMaterial({ color: new THREE.Color('green'), wireframe: false })
//const blueMaterial = new THREE.MeshStandardMaterial({ color: new THREE.Color('blue'), wireframe: false })

const drawCube = (i, material, name) =>
{
...
const animation = () =>
{
	...
	// Voldemort gets bigger
	/*
         for(let i = 0; i < scene.children.length; i++)
        {
            if(scene.children[i].name === "voldermort")
            {
